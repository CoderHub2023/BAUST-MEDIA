                ...
                <form action="{{ route('profile.submit-add-education') }}" method="post">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-lg text-white  mb-4"><input type="text" name="institution" id="institution" placeholder="Institution Name" class="input mb-2 input-bordered input-primary w-full max-w-xs" required/></p>
                            <p id="institutionErr" class="text-red-600"></p>
                            <p class="text-white"><input type="text" name="subject" id="subject" placeholder="Subject" class="input input-bordered input-sm w-full max-w-xs" required/></p>
