...
<form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
    ...
    <div class="flex justify-center items-center bg-gray-100 dark:bg-gray-900 min-h-screen gradient-box2">
        <div class="max-w-screen-sm w-full bg-white dark:bg-gray-800 shadow-lg overflow-hidden gradient-box">
            <div class="px-4 py-8 sm:px-6 md:px-8">
                ...
                <div class="mb-4">
                    <label for="name" class="block font-medium text-white dark:text-gray-200">Name</label>
                ...
                <div class="mb-4">
                    <label for="email" class="block font-medium text-white dark:text-gray-200">Email</label>
                ...
                <div class="mb-4">
                    <label for="password_confirmation" class="block font-medium text-white dark:text-gray-200">Confirm Password</label>
                ...
                <a class="block text-center py-2 text-sm text-white dark:text-white hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('login') }}">
